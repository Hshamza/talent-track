...
import { getRole, updateRole } from "@/lib/storage"
...
const formSchema = z.object({
  ...
  status: z.enum(["active", "draft", "paused", "filled", "closed"], {
...
export default function EditRolePage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    if (!roleData) {
      toast({
        ...
        description: "The role you're trying to edit doesn't exist or has been removed.",
        variant: "destructive",
      })
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      // Update the role
      const updatedRole = updateRole(role.id, values)
      ...
      toast({
        ...
        description: "Your role couldn't be updated. Please try again.",
        variant: "destructive",
      })
    } finally {
    ...
    <div className="flex flex-col gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Update the job posting information. All fields marked with * are required.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                    ...
                    <FormItem>
                      ...
                      >
                        ...
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          ...
                          <FormLabel className="font-normal">Filled</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          <FormControl>
